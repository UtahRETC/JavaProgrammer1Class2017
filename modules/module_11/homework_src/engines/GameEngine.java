...
public class GameEngine {
  ...
  /**
   * Calculates the vertical velocity and the horizontal velocity imparted by the give power and
   * angle and applies that to the ball. Also makes the player let go of the ball.
   */
